...
namespace arcane {
	...
	void Texture::setTextureMagFilter(GLenum textureFilterMode) {
		...
		if (textureFilterMode > GL_LINEAR)
			ARCANE_WARN("Texture Filter Tuning: Texture's magnification filter exceeded bilinear filtering which won't result in any visual improvements and will just cost more");
