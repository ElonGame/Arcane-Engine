...
namespace arcane {
	...
	void Scene3D::init() {
		...
		//pbrGun->getMeshes()[0].getMaterial().setAlbedoMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Cerberus_Gun/Textures/Cerberus_A.tga"), &srgbTextureSettings));
		//pbrGun->getMeshes()[0].getMaterial().setNormalMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Cerberus_Gun/Textures/Cerberus_N.tga")));
		//pbrGun->getMeshes()[0].getMaterial().setMetallicMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Cerberus_Gun/Textures/Cerberus_M.tga")));
		//pbrGun->getMeshes()[0].getMaterial().setRoughnessMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Cerberus_Gun/Textures/Cerberus_R.tga")));
		//pbrGun->getMeshes()[0].getMaterial().setAmbientOcclusionMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Cerberus_Gun/Textures/Cerberus_AO.tga")));
		...
		//hyruleShield->getMeshes()[0].getMaterial().setAlbedoMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Hyrule_Shield/HShield_[Albedo].tga"), &srgbTextureSettings));
		//hyruleShield->getMeshes()[0].getMaterial().setNormalMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Hyrule_Shield/HShield_[Normal].tga")));
		//hyruleShield->getMeshes()[0].getMaterial().setMetallicMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Hyrule_Shield/HShield_[Metallic].tga")));
		//hyruleShield->getMeshes()[0].getMaterial().setRoughnessMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Hyrule_Shield/HShield_[Roughness].tga")));
		//hyruleShield->getMeshes()[0].getMaterial().setAmbientOcclusionMap(editor::TextureLoader::load2DTexture(std::string("res/3D_Models/Hyrule_Shield/HShield_[Occlusion].tga")));
