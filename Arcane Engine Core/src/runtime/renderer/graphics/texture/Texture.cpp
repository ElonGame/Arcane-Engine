...
namespace arcane {
	...
	Texture::Texture(const Texture &texture) : m_TextureId(0), m_TextureTarget(texture.getTextureTarget()), m_Width(texture.getWindowWidth()), m_Height(texture.getWindowHeight()), m_TextureSettings(texture.getTextureSettings()) {
